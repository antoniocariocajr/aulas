...
## Resumo Comparativo: "O que usar quando?"

| Desafio | Sugestão | Por quê? |
| :--- | :--- | :--- |
| **Declarar algo fixo** | `const` | Segurança e imutabilidade. |
| **Iterar um Array** | `for...of` | Mais legível e direto. |
| **Tratar status fixos** | `switch` | Performance e clareza. |
| **Valor padrão p/ variáveis** | `??` ou `||` | Curto-circuito evita `if/else` longos. |
| **Callback simples** | Arrow Function | Sintaxe curta e mantém contexto. |
